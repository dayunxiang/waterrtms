             ...
             >
               ...
               min-width="100">
                ...
                <template slot-scope="scope5">
                            <div class="slotoutbox1">
                                <div class="slotinbox11">{{scope5.row.PumpList[5].Speed}}</div>
                ...
                <template slot-scope="scope6">
                            <div class="slotoutbox1">
                                <div class="slotinbox11">{{scope6.row.PumpList[6].Speed}}</div>
                ...
                <template slot-scope="scope7">
                            <div class="slotoutbox1">
                                <div class="slotinbox11">{{scope7.row.PumpList[7].Speed}}</div>
