...
class Methods {
    loadArcgis() {// 该方法用于加载 arcgis 依赖的js,css 等
        ...
        esriLoader.loadCss('https://10.200.6.71:8084/ztdata/library/3.25/3.25/esri/css/esri.css');
        esriLoader.loadCss('https://10.200.6.71:8084/ztdata/library/3.25/3.25/dijit/themes/tundra/tundra.css');
        // 加载模块
        ...
        window.addEventListener('event_name',function(event){
                ...
                if(typeSelectMain=="updateTime"||typeSelectMain=="changeLayer")
                {
                    ...
                    endDate = event.detail.endDate;
                     ...
                     if(selectTypeMain=="HydraulicGrade"||selectTypeMain=="Pressure"||selectTypeMain=="Demand"||selectTypeMain=="PressureChange")
                    {
